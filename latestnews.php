...
<div class="main">
	<div class="col-sm-12 pad0 headdingnav">
        <div class="col-sm-6 pad0"><div class="headding">Latest Circulars</div></div>
    ...
    <div class="col-sm-12 page_area">
        <div class="header">Add Latest News</div>
        <div class="pagewrok">
			...
			<?php
				if(isset($_POST['submit']))
				{
					...
					$sql="INSERT INTO latest_news(heading,file) values('$heading','$file')";
					$con->query($sql);
        ...
        <div class="pagewrok">
			<table id="example" class="table table-bordered">
				...
				<tbody>
					<?
						$i=1;
						$res=$con->query("select * from latest_news order by(lid) desc");
...
function JSconfirm(delid){
    ...
    if (isConfirm) 
    {   
        window.location = "delete.php?id="+delid+"&&tname=latest_news";   
    } 
    else {     
