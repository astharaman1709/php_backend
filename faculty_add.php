...
<div class="main">
	<div class="col-sm-12 pad0 headdingnav">
        <div class="col-sm-6 pad0"><div class="headding">Faculty</div></div>
        <div class="col-sm-6 pad0" align="right">
            <a href="faculty" class="btn batt"><i class="fa fa-arrow-left"></i> Back</a>
        </div>   
        <div class="clear"></div>
    </div>

    <div class="col-sm-12 page_area">
        <div class="header">Add Faculty</div>
        <div class="pagewrok">
			...
			<?php
				if (isset($_POST["submit"])) 
                {
                	...
                	$sql="INSERT INTO faculty values('','$name','$department','$file')";
					$con->query($sql);
					move_uploaded_file($_FILES['file']['tmp_name'], "files/".$file);

					echo "<script>alert('Record Saved.');</script>";
					echo "<script>window.location.href='faculty_add';</script>";
				}
			?>
		</div>
		<div class="clear"></div>
