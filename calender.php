...
<div class="main">
    <div class="col-sm-12 pad0 headdingnav">
        <div class="col-sm-6 pad0"><div class="headding">Upload Calendar</div></div>
        ...
        <div class="pagewrok">
            ...
            <?php
                ...
                if (isset($_POST["submit"])) 
                {
                    ...
                    $con->query("UPDATE calendar SET file='$name' WHERE id='1'");

                    echo "<script>alert('Record Saved.');</script>";
                    echo "<script>window.location.href='calender';</script>";
                }
            ?>
        </div>
        <div class="clear"></div>
