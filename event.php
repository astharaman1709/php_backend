...
<div class="main">
	<div class="col-sm-12 pad0 headdingnav">
        <div class="col-sm-6 pad0"><div class="headding">Event</div></div>
        ...
        <div class="pagewrok">
			...
			<?php
				if(isset($_POST['submit']))
				{
					...
					$sql="insert into event values('','$date','$file','$heading')";
					$con->query($sql);
        ...
        <div class="pagewrok">
			<table id="example" class="table table-bordered">
				...
				<tbody>
					<?
						$i=1;
						$res=$con->query("select * from event order by(eid) desc");
...
function JSconfirm(delid){
    ...
    if (isConfirm) 
    {   
        window.location = "delete.php?id="+delid+"&&tname=event";   
    } 
    else {     
