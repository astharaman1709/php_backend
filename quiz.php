...
<div class="main">
	<div class="col-sm-12 pad0 headdingnav">
        <div class="col-sm-6 pad0"><div class="headding">Quiz</div></div>
        ...
        <div class="pagewrok">
			...
			<?php
				if(isset($_POST['submit']))
				{
					...
					$sql="INSERT INTO quiz(heading,file) values('$heading','$file')";
					$con->query($sql);
        ...
        <div class="pagewrok">
			<table id="example" class="table table-bordered">
				...
				<tbody>
					<?
						$i=1;
						$res=$con->query("select * from quiz order by(id) desc");
...
function JSconfirm(delid){
    ...
    if (isConfirm) 
    {   
        window.location = "delete.php?id="+delid+"&&tname=quiz";   
    } 
    else {     
