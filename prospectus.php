...
<div class="main">
    <div class="col-sm-12 pad0 headdingnav">
        <div class="col-sm-6 pad0"><div class="headding">Upload Prospectus</div></div>
        ...
        <div class="pagewrok">
            ...
            <?php
                ...
                if (isset($_POST["submit"])) 
                {
                    ...
                    $name ="prospectus.".$extension;
                    move_uploaded_file($_FILES['file']['tmp_name'], "pdf/".$name);
                    $con->query("UPDATE prospectus SET file='$name' WHERE id='1'");

                    echo "<script>alert('Record Saved.');</script>";
                    echo "<script>window.location.href='prospectus';</script>";
                }
            ?>
        </div>
        <div class="clear"></div>
