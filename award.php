...
<div class="main">
	<div class="col-sm-12 pad0 headdingnav">
        <div class="col-sm-6 pad0"><div class="headding">Award</div></div>
    ...
    <div class="col-sm-12 page_area">
        <div class="header">Add Award</div>
        <div class="pagewrok">
			...
			<?php
				if(isset($_POST['submit']))
				{
					...
					$sql="INSERT INTO award(heading,file) values('$heading','$file')";
					$con->query($sql);
        ...
        <div class="pagewrok">
			<table id="example" class="table table-bordered">
				...
				<tbody>
					<?
						$i=1;
						$res=$con->query("select * from award order by(id) desc");
...
function JSconfirm(delid){
    ...
    if (isConfirm) 
    {   
        window.location = "delete.php?id="+delid+"&&tname=award";   
    } 
    else {     
